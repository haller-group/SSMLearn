...
nElements = 5;
kappa = 3; % material damping modulus
...
plotReconstructedTrajectory(xData(indTest(1),:), xLifted(indTest(1),:), 15)
%%
...
plotReconstructedTrajectory(xData(indTest(1),:), xRec(indTest(1),:), 13, 'g')
