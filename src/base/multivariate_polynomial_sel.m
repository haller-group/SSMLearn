function [phi,Exp_mat,D_phi_info] = multivariate_polynomial_sel(k,MinDeg,MaxDeg,idx)
...
Exp_mat_full = []; 
for ii = MinDeg : MaxDeg; Exp_mat_full = [Exp_mat_full; multivariante_exponents(k,ii)]; end
u = sym('u',[1 k]);
