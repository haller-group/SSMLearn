function [RDInfo,R,iT,N,T] = IMDynamicsMap(etaData,varargin)
% [RDInfo,R,iT,N,T] = IMDynamicsMap(etaData)
...
switch options.style
    ...
    case 'normalform'
        ...
        if n_real_eig>0
            ...
            % Polar Normal Form
            N_info = polarNormalForm(N_info,0,Dt);
        end
    otherwise
...
[phi_n,Expmat_n] = multivariatePolynomial(k,2,options.N_PolyOrd);
