function backbonecurves(a,w,SSM_func,T,coord_plot,max_rho,varargin)
...
x_eval = SSM_func(T(z_eval)); amp_eval = transpose(x_eval(coord_plot,:));
...
if isempty(varargin)==0
    ...
    ylabel(['$x_' num2str(coord_plot) '$'],'Interpreter','latex')
